...
public class SubMenuHogar extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub_menu_hogar);

        btnEmergencia = findViewById(R.id.id_btn_submenu_emergencia);
        btnRobo = findViewById(R.id.id_btn_submenu_robo);
        btnPersonal = findViewById(R.id.id_btn_submenu_personal);
        ...
        btnRobo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), CapDatos.class);
                intent.putExtra("key Servicio","Asistencia por Robo");
                startActivity(intent);
            }
        });
        ...
        btnPersonal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), CapDatos.class);
                intent.putExtra("key Servicio","Asistencia Personal");
                startActivity(intent);
            }
        });
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.sub_menu_hogar, menu);
        return true;
    }
