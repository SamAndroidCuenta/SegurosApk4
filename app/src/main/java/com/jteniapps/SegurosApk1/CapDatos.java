...
public class CapDatos extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    TextView receptorServicio;
    Button btnenviarolicitud;
    String bb = "122";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cap_datos);
        btnenviarolicitud = findViewById(R.id.id_btn_enviarsolicitud);

        receptorServicio = findViewById(R.id.id_tiposervicio);
        ...
        String servicio = getIntent().getStringExtra("key Servicio");
        receptorServicio.setText(servicio);

        btnenviarolicitud.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), ClasseMensajeEnvioDatos.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.cap_datos, menu);
        return true;
    }
